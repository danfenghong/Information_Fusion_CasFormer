...
#                     help='path of data')
parser.add_argument('--mask_path', default='../../datasets/Train/mask_train.mat', type=str,
                    help='path of mask')
...
parser.add_argument("--data_path_test",default='../../datasets/Test/cave_test/', type=str,
                        help='path of data')
parser.add_argument('--TrainMask_path', default='../../datasets/Train/mask_train.mat', type=str,
                    help='path of mask')
parser.add_argument('--TestMask_path', default='../../datasets/Test/mask_train.mat', type=str,
                    help='path of mask')
